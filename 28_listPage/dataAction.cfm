    ...
    <div class="col-5 mx-auto  bg-dark p-3 py-5 rounded">
      <form action="" class="text-light" method="post">
        ...
        <div class="form-floating mb-3">
          <input value="#local.values.title#" type="text" class="form-control bg-dark text-white" id="floatingInput" placeholder="" name="title">
          <label for="floatingInput">Title</label>
        </div>
        <div class="form-floating mb-3">
          <input value="#local.values.description#" type="text" class="form-control bg-dark text-white" id="floatingInput" placeholder=""
            name="description">
