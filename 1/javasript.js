...
(function(window, document, $, _) {
    ...
    _.merge(WufooFormLogic.prototype, {
        ...
        gRecaptchaExecute: function(siteKey, action, callback) {
        ...
        handleRecaptcha: function(ev) {
            var el = document.getElementById('grcToken');
            if (el && !el.value) {
                ev.preventDefault();
                var siteKey = el.dataset.siteKey;
                this.gRecaptchaExecute(siteKey, 'form_submit', function(token) {
                    el.value = token;
                    ev.originalEvent.submitter.click();
                });
                return false;
            }
            return true;
        ...
        observeFormSubmit: function() {
            ...
            var self = this;
            $activeForm.on('submit', function(ev) {
                if (self.handleRecaptcha(ev)) {
                    $activeForm.off();
...
(function(window, document, $, _) {
    ...
    _.merge(WufooRuleLogic.prototype, {
        ...
        initializeVariables: function(isEntryManager) {
            if (typeof __RULES !== 'undefined') {
                this.Rules = __RULES;
                this.organizeRulesByTargetField();
            }
...
(function(window, document, $, _) {
    ...
    function resizeCallFromParent(event) {
        if (window.__PF && window.__PF.formLogic) {
